      ...
      {links.map((link) => {
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              "flex h-[8px]  items-center justify-center gap-2 rounded-md  p-3 text-sm font-bold tracking-[0.07em] hover:bg-sky-100 [text-decoration:none] hover:text-blue-600",
              {
